...
# WARNING: Ensure imports from `test_fastapi` comes after this line
from test_fastapi import app, settings, db  # noqa
from test_fastapi.cli import create_user, cli  # noqa
