...
description = """
test_fastapi API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://test_fastapi.com/terms/",
    contact={
        "name": "tuhoang1412",
        "url": "http://test_fastapi.com/contact/",
        "email": "tuhoang1412@test_fastapi.com",
    },
    license_info={
        "name": "The Unlicense",
